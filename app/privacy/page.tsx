    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="py-16">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">We use third-party payment processors to process payments, manage subscriptions, and handle billing. When you make a purchase through the Service, we may share your name, billing address, email address, and transaction details with the payment processor so they can process your payment and comply with legal obligations.</p>
          <p className="text-gray-700">The payment processor acts as a data processor for payment transactions. Please refer to your payment processor’s privacy and terms pages for more details.</p>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-2">Domain Verification & Payment Provider Requirements</h2>
          <p className="text-gray-700">To integrate securely with payment providers and ensure secure checkout, a domain verification or proof of ownership process may be required. Typical methods include placing a verification file at a specified URL on the domain, adding an HTML meta tag to the site, or adding a DNS TXT record.</p>
          <p className="text-gray-700">If you receive a domain verification request from your payment provider, please follow their instructions and notify us via <a href="mailto:hello@manymarkets.com" className="text-uvz-orange font-bold">hello@manymarkets.com</a> if you need assistance.</p>
        </section>
